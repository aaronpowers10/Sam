...
public class StringValueParser implements SamParser {
	...
	public AlphaValue parse(InputSequence in, NamespaceReferences references)
			throws CannotParseException {
		return new AlphaValue(parser.parse(in));
	}
